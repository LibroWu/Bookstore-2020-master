...
BPT<whatDoIKnow,int,220,345> BPT_name("name.file", "mem_name.file");
//ULL::Unrolled_Linked_List<len_hash> ULL_author("author.file", "mem_author.file");
BPT<whatDoIKnow,int,220,345> BPT_author("author.file", "mem_author.file");
//ULL::Unrolled_Linked_List<len_hash> ULL_key("keywords.file", "mem_keywords.file");
BPT<whatDoIKnow,int,220,345> BPT_key("keywords.file", "mem_keywords.file");
